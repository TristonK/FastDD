...
import ch.javasoft.bitset.helpers.ArrayIndexComparator;
...
public class TranslatingTreeSearch implements ITreeSearch {
    ...
    public TranslatingTreeSearch(int[] priorities, List<IBitSet> bitsetList) {
        ...
        // the predicate frequency to sort and organize the tree
    ...
    public boolean containsSubset(IBitSet bitset) {
        return search.containsSubset((LongBitSet) translator.bitsetTransform(bitset));
    }
